		...
		<header id="site-header">
			...
			<div class="menu-secondary-wrapper js-menu-build">
				<div class="container" style="height:50px">	
					...
					<nav id="menu-secondary-container" class="menu static" style="margin-left:82px">
			...
			<div class="large-container">
				<?php 
					if($parent_name == 'In Focus'){
						...
						echo '<aside class="ad-unit check leaderboard" style="margin-bottom: 15px; float: left; margin-top: 33px; display: inline;" >';
