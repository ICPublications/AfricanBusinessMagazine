			 ...
			 /* foreach ( $categories as $category ) : 
					...
					*/
					$latest_posts = get_posts( array(
						//'cat' => $category_id,
						'cat' => '-877, -878, -67, -70, -1056, -68, -69, -1, -1079, -1106,-1062, -1079, -1127, -1152, -715, -1208, -1269',
						'posts_per_page' => 9,
						'orderby' => 'date',
					...
					?>
							<li class="category <?php if ( in_category( 'African Banker' )) { echo 'abk'; } if ( in_category( 'Advertorials' )) { echo 'advertorial'; } ?>">
								<h2 class="category-title <?php if (  $category_label == 'African Banker' ) { echo 'abk'; }; if( in_category('General Electric') ){ echo 'infocuscatbg';	 } ?>">
									<a href="<?php if( in_category('General Electric') ){ echo 'http://africanbusinessmagazine.com/category/company-profile/general-electric/';	 } else{ echo get_category_link( $category_id ); } ?>" title="More articles in <?php echo $category_label; ?>">
										<?php 
											if( in_category('General Electric') ){ 
												echo 'In Focus - General Electric'; 
											}else{ 
