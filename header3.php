				...
				<div class="container">
					...
					<nav id="menu-primary-container" class="menu static">
						<ul id="menu-primary" class="cf">
							<?php 
								$categories = array(
									array('Special Reports', 'Special', 5),
									array('Africa Within', 'Africa', 5),
									array('World Affairs', 'World', 5),
									array('Sector Reports', 'Sector', 5),
									array('Finance', 'Finance', 5),
									array('Profiles and Interviews', 'Interviews', 5),
