...
//
	...
	$companies = array($ecobank, $afdb, $cverde, $wbank, $ge, $crisks);
			...
			<?php
				...
				if ( have_posts() ) : 
					while ( have_posts() ) : the_post();
						...
						if( ( $i == 1 || $i == 4 ) && $paged == 1 ) { echo '<div class="row cf">'; } // Open row for medium sized images
						if( ( $i == 3 || $i == 6 ) && $paged == 1 ) { echo '</div>'; } // Close row for medium sized images
